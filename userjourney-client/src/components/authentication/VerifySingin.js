...
const VerifySingIn = () => {
    const alert = ["Enter the code received in your email to continue"]
    const error = ["Error retrieving account information!"]
    const title = ["Verify Sign In"]
        ...
        <Container className="container">
          ...
          <Grid container>
            ...
            <Grid item className="login-right d-grid-c-c" xs={12} md={6} lg={6}>
               <VerifyOtp title={title} error={error} alert={alert}/>
            </Grid>  
          </Grid>
          <div className=" ">
