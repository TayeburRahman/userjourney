    ...
    <Box sx={{ width: '100%' }}>
      <Box className='p-3 box_peeper' sx={{ width: '100%', mb: 2 }}>
        ...
        <Box className="dp_sh_flex_box">
          <Typography className='add_project_text'>Product List</Typography>
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        src={`${row?.image ? `http://localhost:5000/${row?.image}` : image
                          }`}
                      />
                    </TableCell>
                    <TableCell align="right" className='border-left account'>{row?.name}</TableCell>
      ...
      <AddProduct open={mOpen} setOpen={setMOpen} onState={onState} setOnState={setOnState} />
      <UpdateProducts openEdit={openEdit} setOpenEdit={setOpenEdit} editData={editData} onState={onState} setOnState={setOnState} />
      <DeleteProducts openRemove={openRemove} setOpenRemove={setOpenRemove} removeData={removeData} onState={onState} setOnState={setOnState} />
    </Box>
  );
}
